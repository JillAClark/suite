...
# exclude supporting workshop files from user manual build
 
if tags.has("usermanual"):
   exclude_patterns = ['./dataadmin/postgis/geometries_exercises.rst', '/dataadmin/postgis/']


#def setup(app):
#  app.add_config_value('content', '', True)
